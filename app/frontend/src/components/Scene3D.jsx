...
export default function Scene3D() {
  ...
  return (
    ...
    >
      ...
      <div className="hero-frame absolute bottom-[18%] left-[8%] right-[8%] h-[34vh] border border-[#E8E8E3]/10 bg-[#E8E8E3]/[0.025]" />
      <div className="hero-panel absolute bottom-[24%] left-[16%] h-[22vh] w-[30vw] min-w-[220px] border border-[#D97736]/25 bg-[#0B0B0D]/45" />
      <div className="hero-panel-delayed absolute bottom-[30%] right-[12%] hidden h-[18vh] w-[24vw] border border-[#E8E8E3]/10 bg-[#0B0B0D]/40 md:block" />
